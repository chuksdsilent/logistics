                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $today->sum('total') }} Naira</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $month->sum('total') }} Naira</span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $year->sum('total') }} Naira</span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ $sales->sum('total') }} Naira</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $month_expenses->sum('amount') }} Naira</span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $year_expenses->sum('amount') }} Naira</span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ $expenses->sum('amount') }} Naira</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
